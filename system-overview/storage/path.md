...
structure. See "{cpp:func}`~BPath::Passing`".
...
of course, would have to call {cpp:func}`~BMessage::FindString` to retrieve
your pathname string.
...
to the {cpp:func}`~get::ref` function:
