...
Returns {cpp:expr}`true` if the Data Carrier Detect (DCD) pin is asserted,
...
The default data rate is {cpp:enumerator}`B_19200_BPS`. If the rate is set
